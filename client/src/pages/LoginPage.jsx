        ...
        <div className="min-h-screen bg-[#eef2f2] flex flex-col font-sans selection:bg-orange-100 selection:text-orange-900">
            ...
            <main className="flex-grow flex items-center justify-center p-8 sm:p-12 relative overflow-hidden">
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    <div className="absolute top-1/4 -left-20 w-96 h-96 bg-orange-500/10 rounded-full filter blur-3xl animate-pulse"></div>
                    <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-blue-500/10 rounded-full filter blur-3xl animate-pulse delay-1000"></div>
                </div>

                <div className="max-w-md w-full animate-slideIn relative z-10">
                    <div className="glass-card p-10 rounded-3xl shadow-2xl space-y-8">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="bg-white/50 px-4 text-gray-400 font-bold backdrop-blur-sm">Or continue with</span>
                            </div>
                        </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    <div className="flex justify-between items-center mb-2 ml-1">
                                        ...
                                        <Link to="/forgot-password" size="sm" className="text-xs font-bold text-orange-600 hover:text-orange-500">
                                            Forgot?
                                        </Link>
                                    </div>
                                    <input
                        ...
                        <p className="text-center text-sm text-gray-500 font-medium">
                            New here?{' '}
                            <Link to="/register" className="text-orange-600 font-black hover:underline underline-offset-4 tracking-tight">
                                Create Account
                            </Link>
                        </p>
                    </div>
